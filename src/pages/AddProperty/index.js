...
class AddProperty extends Component {
    ...
    renderFiles() {
        ...
        return !files.length ? (
            <p>Jogue as imagens ou clique aqui para adicioná-las</p>
        ) : (
            files.map(file => <img key={file.name} src={file.preview} alt="Uploaded" />)
        );
    }
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <File 
                    ...
                    className={classNames({ 'withour-files': !this.state.files.length })}  
                >
                    {this.renderFiles()}
                </File>
